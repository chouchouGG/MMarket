...
import cn.learn.trigger.api.IRaffleService;
...
public class RaffleController implements IRaffleService {
    ...
    @Override
    public Response<RaffleResDTO> randomRaffle(@RequestBody RaffleReqDTO requestDTO) {
        try {
            ...
            // 封装返回结果
            Response<RaffleResDTO> response =
                    Response.<RaffleResDTO>builder()
                            .code(ResponseCode.SUCCESS.getCode())
                            .info(ResponseCode.SUCCESS.getInfo())
                            .data(RaffleResDTO.builder()
            ...
            return Response.<RaffleResDTO>builder().code(e.getCode()).info(e.getInfo()).build();
        } catch (Exception e) {
            log.error("随机抽奖失败 strategyId：{}", requestDTO.getStrategyId(), e);
            return Response.<RaffleResDTO>builder()
                    .code(ResponseCode.UNKNOW_ERROR.getCode())
                    .info(ResponseCode.UNKNOW_ERROR.getInfo())
                    .build();
        }
